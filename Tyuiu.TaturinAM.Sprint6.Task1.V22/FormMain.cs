...
using Tyuiu.TaturinAM.Sprint6.Task1.V22.Lib;
namespace Tyuiu.TaturinAM.Sprint6.Task1.V22
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 1 выполнил студент группы СМАРТб-23-1 Татурин А. М.", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
